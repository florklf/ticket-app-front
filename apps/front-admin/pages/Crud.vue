      ...
      <div class="card">
        <Toolbar class="mb-4">
          <template #start>
            <div class="my-2">
              ...
              <Button @click="confirmDeleteSelected" label="Delete" icon="pi pi-trash" class="p-button-danger" :disabled="!selectedProducts || !selectedProducts.length" />
            </div>
          </template>

          <template #end>
            <FileUpload
              mode="basic" accept="image/*" :max-file-size="1000000" label="Import" choose-label="Import"
        ...
        >
          ...
          <Column header-style="min-width:10rem;">
            <template #body="slotProps">
              <Button @click="editProduct(slotProps.data)" icon="pi pi-pencil" class="p-button-rounded p-button-success mr-2" />
        ...
        <Dialog v-model:visible="productDialog" :style="{ width: '450px' }" header="Product Details" :modal="true" class="p-fluid">
          ...
          <div class="formgrid grid">
            <div class="field col">
              ...
              <InputNumber
                id="price" v-model="product.price" mode="currency" currency="USD" locale="en-US"
          ...
          <template #footer>
            ...
            <Button @click="saveProduct" label="Save" icon="pi pi-check" class="p-button-text" />
          </template>
        </Dialog>
        ...
        <Dialog v-model:visible="deleteProductDialog" :style="{ width: '450px' }" header="Confirm" :modal="true">
          ...
          <template #footer>
            <Button @click="deleteProductDialog = false" label="No" icon="pi pi-times" class="p-button-text" />
            <Button @click="deleteProduct" label="Yes" icon="pi pi-check" class="p-button-text" />
          </template>
        </Dialog>
        ...
        <Dialog v-model:visible="deleteProductsDialog" :style="{ width: '450px' }" header="Confirm" :modal="true">
          ...
          <template #footer>
            <Button @click="deleteProductsDialog = false" label="No" icon="pi pi-times" class="p-button-text" />
            <Button @click="deleteSelectedProducts" label="Yes" icon="pi pi-check" class="p-button-text" />
          </template>
        </Dialog>
      </div>
    </div>
