    ...
    <div class="col-12 xl:col-6">
      ...
      <div class="card">
        <div class="flex justify-content-between align-items-center mb-5">
          ...
          <div>
            <Button @click="$refs.menu2.toggle($event)" icon="pi pi-ellipsis-v" class="p-button-text p-button-plain p-button-rounded" />
    ...
    <div class="col-12 xl:col-6">
      ...
      <div class="card">
        <div class="flex align-items-center justify-content-between mb-4">
          <h5>Notifications</h5>
          <div>
            <Button @click="$refs.menu1.toggle($event)" icon="pi pi-ellipsis-v" class="p-button-text p-button-plain p-button-rounded" />
