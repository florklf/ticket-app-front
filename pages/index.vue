      ...
      <div class="cards">
        <div class="card prisma__card">
          <div class="card__body">
            ...
            <p>
              ...
              model, automated migrations, type-safety & auto-completion.
            </p>
          </div>
        ...
        <div class="card auth__card">
          <div class="card__body">
            ...
            <p>
              Nuxt user authentication and sessions through nuxt-auth. nuxt-auth wraps NextAuth.js to offer the
              reliability & convenience of a 12k star library to the nuxt 3 ecosystem with a native developer experience
              (DX)
            </p>
          </div>
          <p class="card__action">
